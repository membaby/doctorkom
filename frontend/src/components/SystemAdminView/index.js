...
export default function AdminHomePage() {
    ...
    useEffect(() => {
        fetch('http://localhost:8080/adminInsights')
                ...
                <div class="row gy-4 row-cols-2 row-cols-md-4">
                    <div class="col">
                        <div class="text-center d-flex flex-column justify-content-center align-items-center py-3">
                            ...
                            <div class="px-3">
                                <h2 class="fw-bold mb-0">{insights.totalUsers}</h2>
                    ...
                    <div class="col">
                        <div class="text-center d-flex flex-column justify-content-center align-items-center py-3">
                            ...
                            <div class="px-3">
                                <h2 class="fw-bold mb-0">{insights.doctors}</h2>
                    ...
                    <div class="col">
                        <div class="text-center d-flex flex-column justify-content-center align-items-center py-3">
                            ...
                            <div class="px-3">
                                <h2 class="fw-bold mb-0">{insights.clinics}</h2>
                    ...
                    <div class="col">
                        <div class="text-center d-flex flex-column justify-content-center align-items-center py-3">
                            ...
                            <div class="px-3">
                                <h2 class="fw-bold mb-0">{insights.appointments}</h2>
